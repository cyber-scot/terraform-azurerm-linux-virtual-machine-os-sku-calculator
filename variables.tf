variable "standard_os" {
  default = {
    ...
    "Ubuntu22.04"            = "Canonical,0001-com-ubuntu-server-jammy-daily,22_04-lts"
    "Ubuntu22.04Gen2"        = "Canonical,0001-com-ubuntu-server-jammy-daily,22_04-lts-gen2"
    "Ubuntu23.04"            = "Canonical,0001-com-ubuntu-server-jammy-daily,23_04"
    "Ubuntu23.04Gen2"        = "Canonical,0001-com-ubuntu-server-jammy-daily,23_04-gen2"
